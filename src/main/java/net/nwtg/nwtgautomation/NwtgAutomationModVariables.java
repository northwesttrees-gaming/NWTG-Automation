package net.nwtg.nwtgautomation;
...
public class NwtgAutomationModVariables {
	public NwtgAutomationModVariables(NwtgAutomationModElements elements) {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote()) {
			...
			if (mapdata != null)
				NwtgAutomationMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "nwtg_automation_worldvars";
		...
		public void syncData(IWorld world) {
			...
			if (world instanceof World && !world.isRemote())
				NwtgAutomationMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(((World) world)::getDimensionKey),
	...
	public static class MapVariables extends WorldSavedData {
		public static final String DATA_NAME = "nwtg_automation_mapvars";
		public double nwtgAutomationModVersion = 1.0;
		public MapVariables() {
			super(DATA_NAME);
		}
		...
		@Override
		public void read(CompoundNBT nbt) {
			nwtgAutomationModVersion = nbt.getDouble("nwtgAutomationModVersion");
		}

		@Override
		public CompoundNBT write(CompoundNBT nbt) {
			nbt.putDouble("nwtgAutomationModVersion", nwtgAutomationModVersion);
			return nbt;
		}
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (world instanceof World && !world.isRemote())
				NwtgAutomationMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("nwtg_automation", "player_variables"), new PlayerVariablesProvider());
	}
	...
	public static class PlayerVariables {
		...
		public void syncPlayerVariables(Entity entity) {
			if (entity instanceof ServerPlayerEntity)
				NwtgAutomationMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) entity),

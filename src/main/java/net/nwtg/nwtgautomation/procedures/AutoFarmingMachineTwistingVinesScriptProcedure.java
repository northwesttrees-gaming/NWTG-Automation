...
public class AutoFarmingMachineTwistingVinesScriptProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency x for procedure AutoFarmingMachineTwistingVinesScript!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency y for procedure AutoFarmingMachineTwistingVinesScript!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency z for procedure AutoFarmingMachineTwistingVinesScript!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency world for procedure AutoFarmingMachineTwistingVinesScript!");
			return;
		}
		...
		if ((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				&& (((world.getBlockState(new BlockPos((int) posX, (int) (posY + 1), (int) posZ))).getBlock() == Blocks.TWISTING_VINES)
						&& ((world.getBlockState(new BlockPos((int) posX, (int) posY, (int) posZ))).getBlock() == Blocks.TWISTING_VINES_PLANT)))) {
			seeds = new ItemStack(Blocks.TWISTING_VINES);
			seedsCount = (double) 1;
			if ((((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
			...
			if ((((new Object() {
				...
				world.setBlockState(new BlockPos((int) posX, (int) (posY + 1), (int) posZ), Blocks.AIR.getDefaultState(), 3);
				{
					BlockPos _bp = new BlockPos((int) posX, (int) posY, (int) posZ);
					BlockState _bs = Blocks.TWISTING_VINES.getDefaultState();

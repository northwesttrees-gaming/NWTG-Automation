	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				&& ((!((world.getBlockState(new BlockPos((int) posX, (int) (posY + 1), (int) posZ))).getBlock() == Blocks.SUGAR_CANE))
						&& (((world.getBlockState(new BlockPos((int) posX, (int) (posY - 1), (int) posZ))).getBlock() == Blocks.SUGAR_CANE)
								&& ((world.getBlockState(new BlockPos((int) posX, (int) posY, (int) posZ))).getBlock() == Blocks.SUGAR_CANE))))) {
			...
			if ((((new Object() {
				...
				if (((((world.getBlockState(new BlockPos((int) posX, (int) posY, (int) (posZ + 1)))).getFluidState().isSource())
						|| ((world.getBlockState(new BlockPos((int) posX, (int) posY, (int) (posZ - 1)))).getFluidState().isSource()))
						|| (((world.getBlockState(new BlockPos((int) (posX - 1), (int) posY, (int) posZ))).getFluidState().isSource())
								|| ((world.getBlockState(new BlockPos((int) (posX + 1), (int) posY, (int) posZ))).getFluidState().isSource())))) {
					{

		...
		if ((((((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				...
				.getTagByID(new ResourceLocation(
						("forge:nwtg_automation/items/recipes/auto_crafting_machine/spruce_log").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
					...
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						&& ((((new Object() {
							public int getAmount(IWorld world, BlockPos pos, int sltid) {
								...
								.getTagByID(new ResourceLocation(("forge:nwtg_automation/items/recipes/auto_crafting_machine/spruce_log")
									...
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										...
										.getItem()) && ((((new Object() {
											public int getAmount(IWorld world, BlockPos pos, int sltid) {
												...
												.getTagByID(
														new ResourceLocation(("forge:nwtg_automation/items/recipes/auto_crafting_machine/spruce_log")
																.toLowerCase(java.util.Locale.ENGLISH)))
												.contains((new Object() {
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
												...
												.getItem() == new ItemStack(Blocks.AIR, (int) (1)).getItem()) && ((((new Object() {
													public int getAmount(IWorld world, BlockPos pos, int sltid) {
														...
														&& (ItemTags.getCollection()
																.getTagByID(new ResourceLocation(
																		("forge:nwtg_automation/items/recipes/auto_crafting_machine/spruce_log")
																				.toLowerCase(java.util.Locale.ENGLISH)))
																.contains((new Object() {
																	public ItemStack getItemStack(BlockPos pos, int sltid) {
																		AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);

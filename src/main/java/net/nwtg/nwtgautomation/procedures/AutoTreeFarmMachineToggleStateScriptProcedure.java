	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			if ((BlockTags.getCollection()
				...
				if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == AutoTreeFarmMachineOnBlock.block.getDefaultState()
						.getBlock())) {
					{
				...
				if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == AutoTreeFarmMachineBlock.block.getDefaultState()
						.getBlock())) {
					{
						BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);

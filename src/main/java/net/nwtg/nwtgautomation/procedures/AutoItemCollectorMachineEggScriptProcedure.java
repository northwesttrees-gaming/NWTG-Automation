...
public class AutoItemCollectorMachineEggScriptProcedure extends NwtgAutomationModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "ItemPosX"));
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "ItemPosY"));
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "ItemPosZ"));
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "ItemPosX")) + 0.5);
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "ItemPosY")) + 0.5);
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "ItemPosZ")) + 0.5);
		if (((((new Object() {
			...
			if (world instanceof ServerWorld) {
				((World) world).getServer().getCommandManager().handleCommand(
						...
						(("execute as @e[type=minecraft:item,name=Egg,") + "" + ((new java.text.DecimalFormat("##").format((posX)))) + "" + (" ") + ""
								+ ((new java.text.DecimalFormat("##").format((posY)))) + "" + (" ") + ""
								+ ((new java.text.DecimalFormat("##").format((posZ)))) + ""
								+ (",dx=1,dy=1,dz=1] run data merge entity @s {Age:6000}")));
			}
			if (world instanceof ServerWorld) {
				((World) world).getServer().getCommandManager().handleCommand(
						new CommandSource(ICommandSource.DUMMY, new Vector3d(x, y, z), Vector2f.ZERO, (ServerWorld) world, 4, "",

...
public class AutoTreeFarmMachineBlockIsPlacedByProcedure extends NwtgAutomationModElements.ModElement {
	public AutoTreeFarmMachineBlockIsPlacedByProcedure(NwtgAutomationModElements instance) {
		super(instance, 274);
	}

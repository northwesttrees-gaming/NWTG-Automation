		...
		if ((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				&& (((!((world.getBlockState(new BlockPos((int) posX, (int) (posY + 1), (int) posZ))).getBlock() == Blocks.KELP))
						&& (!((world.getBlockState(new BlockPos((int) posX, (int) (posY + 1), (int) posZ))).getBlock() == Blocks.KELP_PLANT)))
						&& (((world.getBlockState(new BlockPos((int) posX, (int) (posY - 1), (int) posZ))).getBlock() == Blocks.KELP_PLANT)
								&& ((world.getBlockState(new BlockPos((int) posX, (int) posY, (int) posZ))).getBlock() == Blocks.KELP))))) {
			seeds = new ItemStack(Blocks.KELP);
			seedsCount = (double) 1;
			if ((((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);

...
public class AutoFarmingMachineWeepingVineScriptProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency x for procedure AutoFarmingMachineWeepingVineScript!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency y for procedure AutoFarmingMachineWeepingVineScript!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency z for procedure AutoFarmingMachineWeepingVineScript!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency world for procedure AutoFarmingMachineWeepingVineScript!");
			return;
		}
		...
		if ((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				&& (((world.getBlockState(new BlockPos((int) posX, (int) (posY + 1), (int) posZ))).getBlock() == Blocks.WEEPING_VINES_PLANT)
						&& ((world.getBlockState(new BlockPos((int) posX, (int) posY, (int) posZ))).getBlock() == Blocks.WEEPING_VINES)))) {
			seeds = new ItemStack(Blocks.WEEPING_VINES);
			seedsCount = (double) 1;
			if ((((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
			...
			if ((((new Object() {
				...
				world.setBlockState(new BlockPos((int) posX, (int) posY, (int) posZ), Blocks.AIR.getDefaultState(), 3);
				{
					...
					BlockState _bs = Blocks.WEEPING_VINES.getDefaultState();

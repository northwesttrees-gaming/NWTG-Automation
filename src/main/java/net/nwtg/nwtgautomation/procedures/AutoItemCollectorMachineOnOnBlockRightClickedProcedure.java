...
public class AutoItemCollectorMachineOnOnBlockRightClickedProcedure extends NwtgAutomationModElements.ModElement {
	public AutoItemCollectorMachineOnOnBlockRightClickedProcedure(NwtgAutomationModElements instance) {
		super(instance, 56);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("direction") == null) {
			if (!dependencies.containsKey("direction"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency direction for procedure AutoItemCollectorMachineOnOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency entity for procedure AutoItemCollectorMachineOnOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency x for procedure AutoItemCollectorMachineOnOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency y for procedure AutoItemCollectorMachineOnOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency z for procedure AutoItemCollectorMachineOnOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency world for procedure AutoItemCollectorMachineOnOnBlockRightClicked!");
			return;
		}

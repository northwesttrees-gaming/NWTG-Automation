...
public class AutoCraftingMachineBreadRecipeProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((((new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == Items.WHEAT) && ((new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == Items.WHEAT) && ((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == Items.WHEAT) && ((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
			...
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(Items.BREAD);
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (3))).getItem() == Items.WHEAT) && ((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (4))).getItem() == Items.WHEAT) && ((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (5))).getItem() == Items.WHEAT) && ((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (6))).getItem() == Items.WHEAT) && ((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (7))).getItem() == Items.WHEAT) && ((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (8))).getItem() == Items.WHEAT) && ((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {

...
public class AutoCraftingMachineSortingScriptWestProcedure extends NwtgAutomationModElements.ModElement {
	public AutoCraftingMachineSortingScriptWestProcedure(NwtgAutomationModElements instance) {
		super(instance, 62);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency x for procedure AutoCraftingMachineSortingScriptWest!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency y for procedure AutoCraftingMachineSortingScriptWest!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency z for procedure AutoCraftingMachineSortingScriptWest!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency world for procedure AutoCraftingMachineSortingScriptWest!");
			return;
		}
		...
		double outputSlot = 0;
		if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z - 1)))).getBlock() == Blocks.CHEST.getDefaultState().getBlock())
				...
				if (((moveToCraftingSlot) == (true))) {
					...
					if (((dontMoveToOutput) == (false))) {
						...
						for (int index2 = 0; index2 < (int) (27); index2++) {
							if ((((new Object() {
								public ItemStack getItemStack(BlockPos pos, int sltid) {
							...
							}.getItemStack(new BlockPos((int) x, (int) y, (int) (z - 1)), (int) ((outputSlot))))
									.getItem() == new ItemStack(Blocks.AIR, (int) (1)).getItem()) || (((new Object() {
										public int getAmount(IWorld world, BlockPos pos, int sltid) {
											AtomicInteger _retval = new AtomicInteger(0);
											TileEntity _ent = world.getTileEntity(pos);
									...
									}.getAmount(world, new BlockPos((int) x, (int) y, (int) (z + 1)), (int) ((outputSlot)))) <= 63)
											&& ((new Object() {
												public ItemStack getItemStack(BlockPos pos, int sltid) {
													AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
													TileEntity _ent = world.getTileEntity(pos);

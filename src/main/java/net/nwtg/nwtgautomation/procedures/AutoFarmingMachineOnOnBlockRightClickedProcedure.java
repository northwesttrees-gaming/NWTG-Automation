...
public class AutoFarmingMachineOnOnBlockRightClickedProcedure extends NwtgAutomationModElements.ModElement {
	public AutoFarmingMachineOnOnBlockRightClickedProcedure(NwtgAutomationModElements instance) {
		super(instance, 32);
	}

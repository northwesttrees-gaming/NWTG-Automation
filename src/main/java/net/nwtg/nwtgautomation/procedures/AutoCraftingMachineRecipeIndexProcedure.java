...
public class AutoCraftingMachineRecipeIndexProcedure extends NwtgAutomationModElements.ModElement {
	public AutoCraftingMachineRecipeIndexProcedure(NwtgAutomationModElements instance) {
		super(instance, 89);
	}

...
public class AutoCraftingMachineOnUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			if ((BlockTags.getCollection()
				...
				if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == AutoCraftingMachineOnBlock.block)) {
					{
				...
				if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == AutoCraftingMachineBlock.block)) {
					{
						BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);

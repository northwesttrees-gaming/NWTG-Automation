		...
		if ((((((new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				...
				.getTagByID(new ResourceLocation(
						("forge:nwtg_automation/items/recipes/auto_crafting_machine/birch_log").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
				...
				&& (((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						|| (((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (9))).getItem() == new ItemStack(Blocks.BIRCH_PLANKS, (int) (1))
								.getItem()) && ((new Object() {
									public int getAmount(IWorld world, BlockPos pos, int sltid) {
										AtomicInteger _retval = new AtomicInteger(0);
										TileEntity _ent = world.getTileEntity(pos);
								...
								}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (9))) <= 60))))) {
			{
			...
			}
			{
				...
				if (_ent != null) {
					...
					}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (9))) + 4));
					_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
						if (capability instanceof IItemHandlerModifiable) {
					...
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						&& ((((new Object() {
							public int getAmount(IWorld world, BlockPos pos, int sltid) {
								...
								.getTagByID(new ResourceLocation(("forge:nwtg_automation/items/recipes/auto_crafting_machine/birch_log")
									...
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										...
										.getItem()) && ((((new Object() {
											public int getAmount(IWorld world, BlockPos pos, int sltid) {
												...
												.getTagByID(
														new ResourceLocation(("forge:nwtg_automation/items/recipes/auto_crafting_machine/birch_log")
																.toLowerCase(java.util.Locale.ENGLISH)))
												.contains((new Object() {
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
												...
												.getItem() == new ItemStack(Blocks.AIR, (int) (1)).getItem()) && ((((new Object() {
													public int getAmount(IWorld world, BlockPos pos, int sltid) {
														...
														&& (ItemTags.getCollection()
																.getTagByID(new ResourceLocation(
																		("forge:nwtg_automation/items/recipes/auto_crafting_machine/birch_log")
																				.toLowerCase(java.util.Locale.ENGLISH)))
																.contains((new Object() {
																	public ItemStack getItemStack(BlockPos pos, int sltid) {
																		AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);

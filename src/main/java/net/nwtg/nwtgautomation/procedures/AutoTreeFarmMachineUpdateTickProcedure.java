...
public class AutoTreeFarmMachineUpdateTickProcedure extends NwtgAutomationModElements.ModElement {
	public AutoTreeFarmMachineUpdateTickProcedure(NwtgAutomationModElements instance) {
		super(instance, 270);
	}

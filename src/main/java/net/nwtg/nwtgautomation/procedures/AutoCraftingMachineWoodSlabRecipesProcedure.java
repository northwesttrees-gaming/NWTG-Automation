...
public class AutoCraftingMachineWoodSlabRecipesProcedure extends NwtgAutomationModElements.ModElement {
	public AutoCraftingMachineWoodSlabRecipesProcedure(NwtgAutomationModElements instance) {
		super(instance, 123);
	}

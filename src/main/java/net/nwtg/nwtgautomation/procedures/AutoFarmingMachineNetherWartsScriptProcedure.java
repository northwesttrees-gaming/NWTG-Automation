...
public class AutoFarmingMachineNetherWartsScriptProcedure extends NwtgAutomationModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((((new Object() {
			...
			public ItemStack getItemStack(BlockPos pos, int sltid) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(Items.NETHER_WART, (int) (1)).getItem())))
				&& (((new Object() {
					public int getAmount(IWorld world, BlockPos pos, int sltid) {
						AtomicInteger _retval = new AtomicInteger(0);
						TileEntity _ent = world.getTileEntity(pos);
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(Items.NETHER_WART, (int) (1))
						.getItem()))))) {
			...
			if (world instanceof ServerWorld) {
				((World) world).getServer().getCommandManager().handleCommand(
						...
						(("setblock ") + "" + ((new java.text.DecimalFormat("##").format((posX)))) + "" + (" ") + ""
								...
								+ ((new java.text.DecimalFormat("##").format((posZ)))) + "" + (" minecraft:sweet_berry_bush[age=0]")));
			}
		...
		if ((((new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(Items.NETHER_WART, (int) (1)).getItem())))) {
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(Items.NETHER_WART, (int) (1));
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(Items.NETHER_WART, (int) (1)).getItem())))) {
			{
				TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
				if (_ent != null) {

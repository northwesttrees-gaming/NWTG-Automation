...
public class AutoCraftingMachineSaplingRecipesProcedure extends NwtgAutomationModElements.ModElement {
	public AutoCraftingMachineSaplingRecipesProcedure(NwtgAutomationModElements instance) {
		super(instance, 299);
	}

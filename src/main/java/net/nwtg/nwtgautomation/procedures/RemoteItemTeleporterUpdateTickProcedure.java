	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			if ((BlockTags.getCollection()
					.getTagByID(new ResourceLocation(("nwtg_automation:machines/auto_farming").toLowerCase(java.util.Locale.ENGLISH)))
				...
				for (int index0 = 0; index0 < (int) (9); index0++) {
					...
					}.getAmount(world, new BlockPos((int) x, (int) (y - 1), (int) z), (int) (1))) > 1) && (((new Object() {
						public int getAmount(IWorld world, BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
							if (_ent != null) {
					...
					}.getAmount(world, new BlockPos((int) x, (int) (y - 1), (int) z), (int) (2))) > 1) && (((new Object() {
						public int getAmount(IWorld world, BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
							if (_ent != null) {
			...
			if ((((BlockTags.getCollection()
				...
				for (int index5 = 0; index5 < (int) (9); index5++) {
					...
					}.getItemStack(new BlockPos((int) x, (int) y, (int) (z + 1)), (int) (2))).getItem() == Blocks.AIR.asItem()) || (((new Object() {
						public ItemStack getItemStack(BlockPos pos, int sltid) {
							AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
							TileEntity _ent = world.getTileEntity(pos);
							if (_ent != null) {
			...
			if ((((BlockTags.getCollection()
				...
				for (int index6 = 0; index6 < (int) (9); index6++) {
					...
					}.getItemStack(new BlockPos((int) (x - 1), (int) y, (int) z), (int) (2))).getItem() == Blocks.AIR.asItem()) || (((new Object() {
						public ItemStack getItemStack(BlockPos pos, int sltid) {
							AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
							TileEntity _ent = world.getTileEntity(pos);
							if (_ent != null) {

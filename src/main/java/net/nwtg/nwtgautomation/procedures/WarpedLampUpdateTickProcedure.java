...
public class WarpedLampUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency x for procedure WarpedLampUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency y for procedure WarpedLampUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency z for procedure WarpedLampUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				NwtgAutomationMod.LOGGER.warn("Failed to load dependency world for procedure WarpedLampUpdateTick!");
			return;
		}
		...
		if (((new Object() {
			...
			if (((new Object() {
				...
				if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == WarpedLampOnBlock.block)) {
					{
						BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);

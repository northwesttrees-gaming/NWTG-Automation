	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((((new Object() {
			...
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(Items.POTATO, (int) (1))
						.getItem()))))) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(Items.POTATO, (int) (1)).getItem())))) {
			{
				TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
				if (_ent != null) {

...
public class SolarPanelOnBlock extends NwtgAutomationModElements.ModElement {
	@ObjectHolder("nwtg_automation:solar_panel_on")
	public static final Block block = null;
	@ObjectHolder("nwtg_automation:solar_panel_on")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SolarPanelOnBlock(NwtgAutomationModElements instance) {
		super(instance, 359);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("solar_panel_on"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("solar_panel_on");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SolarPanelOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("solar_panel_on");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new SolarPanelScreenGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}

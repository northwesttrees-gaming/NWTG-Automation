...
public class AutoItemCollectorMachineBlock extends NwtgAutomationModElements.ModElement {
	@ObjectHolder("nwtg_automation:auto_item_collector_machine")
	public static final Block block = null;
	@ObjectHolder("nwtg_automation:auto_item_collector_machine")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public AutoItemCollectorMachineBlock(NwtgAutomationModElements instance) {
		super(instance, 4);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("auto_item_collector_machine"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("auto_item_collector_machine");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				AutoItemCollectorMachineOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("auto_item_collector_machine");
		}

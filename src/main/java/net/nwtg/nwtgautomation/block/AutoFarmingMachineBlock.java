...
public class AutoFarmingMachineBlock extends NwtgAutomationModElements.ModElement {
	@ObjectHolder("nwtg_automation:auto_farming_machine")
	public static final Block block = null;
	@ObjectHolder("nwtg_automation:auto_farming_machine")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public AutoFarmingMachineBlock(NwtgAutomationModElements instance) {
		super(instance, 3);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("auto_farming_machine"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				AutoFarmingMachineOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("auto_farming_machine");
		}

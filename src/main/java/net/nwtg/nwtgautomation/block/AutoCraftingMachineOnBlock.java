...
public class AutoCraftingMachineOnBlock extends NwtgAutomationModElements.ModElement {
	@ObjectHolder("nwtg_automation:auto_crafting_machine_on")
	public static final Block block = null;
	@ObjectHolder("nwtg_automation:auto_crafting_machine_on")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public AutoCraftingMachineOnBlock(NwtgAutomationModElements instance) {
		super(instance, 22);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("auto_crafting_machine_on"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("auto_crafting_machine_on");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				AutoCraftingMachineOnOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("auto_crafting_machine_on");
		}

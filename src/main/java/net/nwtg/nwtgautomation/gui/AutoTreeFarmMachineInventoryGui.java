...
public class AutoTreeFarmMachineInventoryGui extends NwtgAutomationModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("auto_tree_farm_machine_inventory"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, AutoTreeFarmMachineInventoryGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 61, 37) {
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 124, 37) {
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 151, 37) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)

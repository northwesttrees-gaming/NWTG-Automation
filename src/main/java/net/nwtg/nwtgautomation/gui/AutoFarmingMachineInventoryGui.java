...
public class AutoFarmingMachineInventoryGui extends NwtgAutomationModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public AutoFarmingMachineInventoryGui(NwtgAutomationModElements instance) {
		super(instance, 9);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("auto_farming_machine_inventory"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, AutoFarmingMachineInventoryGuiWindow::new));
	}
